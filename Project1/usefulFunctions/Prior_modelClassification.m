function [classifier, yhat, Loss] = Prior_modelClassification(features, labels, discrimtype)
%utile pour la partie 1 du guidesheet2


classifier = fitcdiscr(features, labels, 'DiscrimType', discrimtype,'Prior', 'uniform');
